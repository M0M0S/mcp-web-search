...
class TestFullPipeline:
    ...
    async def test_full_pipeline_with_dedup(
        ...
        with patch(
            "app.services.webfetch_service.create_llm_client",
    ...
    async def test_checkpoint_resume_with_dedup(
        ...
        with patch(
            ...
            state1.selected_urls = [
                ...
                URLSelectionItem(
                    url="https://example.com/2", priority=2, reason="test"
                ),
            ]
    ...
    async def test_checkpoint_resume_duplicated_urls(
        ...
        with patch(
            ...
            state_cp.selected_urls = [
                URLSelectionItem(
                    url="https://example.com/dup", priority=1, reason="r1"
                ),
                URLSelectionItem(
                    url="https://example.com/dup", priority=2, reason="r2"
                ),
            ]
    ...
    async def test_checkpoint_resume_scoring_always(
        ...
        with patch(
            ...
            state_cp.fetched_content = [
                {"url": "https://example.com/1", "text": "content"}
            ]
            state_cp.selected_urls = [
    ...
    async def test_truncation_no_truncation_for_small_content(
        ...
        with patch(
            ...
            state.fetched_content = [
                {"url": "https://example.com/1", "text": short_text}
            ]
